...
import XCTest
  ...
  final class MemberGeneratorTests: XCTestCase {
    ...
    func testGenerateLockmanInfoMembersWithPublicEnum() {
      ...
      let generatedCode = members.first!.description
      XCTAssertTrue(generatedCode.contains("public func createLockmanInfo() -> LockmanSingleExecutionInfo"))
    ...
    func testGenerateLockmanInfoMembersWithInternalEnum() {
      ...
      let generatedCode = members.first!.description
      XCTAssertTrue(generatedCode.contains("internal func createLockmanInfo() -> LockmanSingleExecutionInfo"))
    }
