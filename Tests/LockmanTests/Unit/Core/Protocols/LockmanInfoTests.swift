...
final class LockmanInfoTests: XCTestCase {
  ...
  private struct TestBasicInfo: LockmanInfo {
    ...
    init(strategyId: LockmanStrategyId = "testStrategy", actionId: LockmanActionId = "testAction", customData: String = "") {
  ...
  private struct TestCancellableInfo: LockmanInfo {
    ...
    init(strategyId: LockmanStrategyId = "cancellableStrategy", actionId: LockmanActionId = "cancellableAction", isCancellable: Bool = true) {
      self.strategyId = strategyId
      self.actionId = actionId
      self.uniqueId = UUID()
  ...
  func testLockmanInfoStrategyIdUsage() {
    ...
    let configuredInfo = TestBasicInfo(strategyId: LockmanStrategyId(name: "RateLimit", configuration: "burst-10"))
