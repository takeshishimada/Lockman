...
final class LockmanStrategyTests: XCTestCase {
  ...
  private struct TestStrategyError: LockmanError {
    ...
    static func mockFailure(info: any LockmanInfo, boundaryId: any LockmanBoundaryId) -> TestStrategyError {
      TestStrategyError(info: info, boundaryId: String(describing: boundaryId), reason: "Mock failure")
    }
