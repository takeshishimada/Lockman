...
final class LockmanPriorityBasedStrategyTests: XCTestCase {
  ...
  func testLockmanPriorityBasedStrategyTypeAlias() {
    ...
    let info = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("test"), priority: .high(.exclusive))
  ...
  func testLockmanPriorityBasedStrategyBasicCanLock() {
    ...
    let noneInfo = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("noneAction"), priority: .none)
    ...
    let highInfo = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("highAction"), priority: .high(.exclusive))
    ...
    let lowInfo = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("lowAction"), priority: .low(.exclusive))
  ...
  func testLockmanPriorityBasedStrategyBasicLockUnlock() {
    ...
    let info = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("action"), priority: .high(.exclusive))
    ...
    let secondInfo = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("action2"), priority: .high(.exclusive))
  ...
  func testLockmanPriorityBasedStrategyHighPriorityExclusive() {
    ...
    let info1 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("highAction1"), priority: .high(.exclusive))
    let info2 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("highAction2"), priority: .high(.exclusive))
  ...
  func testLockmanPriorityBasedStrategyHighPriorityReplaceable() {
    ...
    let info1 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("highAction1"), priority: .high(.replaceable))
    let info2 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("highAction2"), priority: .high(.replaceable))
  ...
  func testLockmanPriorityBasedStrategyLowPriorityExclusive() {
    ...
    let info1 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("lowAction1"), priority: .low(.exclusive))
    let info2 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("lowAction2"), priority: .low(.exclusive))
  ...
  func testLockmanPriorityBasedStrategyLowPriorityReplaceable() {
    ...
    let info1 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("lowAction1"), priority: .low(.replaceable))
    let info2 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("lowAction2"), priority: .low(.replaceable))
  ...
  func testLockmanPriorityBasedStrategyMultipleBoundaries() {
    ...
    let info3 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("action3"), priority: .high(.exclusive))
  ...
  func testLockmanPriorityBasedStrategyBoundarySpecificCleanup() {
    ...
    let info1 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("action1"), priority: .high(.exclusive))
    let info2 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("action2"), priority: .high(.exclusive))
    ...
    let testInfo1 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("test1"), priority: .high(.exclusive))
    ...
    let testInfo2 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("test2"), priority: .high(.exclusive))
  ...
  func testLockmanPriorityBasedStrategyMixedNoneAndPriorityActions() {
    ...
    let noneInfo2 = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("noneAction2"), priority: .none)
  ...
  func testLockmanPriorityBasedStrategyTypeErasure() {
    ...
    let testInfo = LockmanPriorityBasedInfo(
      actionId: LockmanActionId("testAction"), priority: .high(.exclusive))
