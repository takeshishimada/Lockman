...
//    let baseReducer = ReducerTestReducer()
//
//    let lockmanReducer = baseReducer.lock<TestAction>(
//      boundaryId: TestBoundaryId.test
//    )
//
...
//    let baseReducer = ReducerTestReducer()
//
//    let lockmanReducer = baseReducer.lock<ViewAction>(
//      boundaryId: TestBoundaryId.test,
//      for: \.view
//    )
//
...
//    let reducer1 = baseReducer.lock<ViewAction>(boundaryId: TestBoundaryId.test, for: \.view)
//    let reducer2 = baseReducer.lock<DelegateAction>(boundaryId: TestBoundaryId.test, for: \.delegate)
//    let reducer3 = baseReducer.lock<TestAction>(boundaryId: TestBoundaryId.test, for: \.increment)
//
...
//    let lockmanReducer =
//      baseReducer
//      .lock<TestAction>(boundaryId: TestBoundaryId.test)
//      .lock<TestAction>(boundaryId: TestBoundaryId.feature)
//
...
//    let reducer2 = baseReducer.lock<TestAction>(boundaryId: TestBoundaryId.feature)
//
...
//    let complexReducer =
//      baseReducer
//      .lock<ViewAction>(boundaryId: TestBoundaryId.test, for: \.view)
//      .lock<DelegateAction>(boundaryId: TestBoundaryId.feature, for: \.delegate)
//
...
//    let feature1Reducer = baseReducer.lock<ViewAction>(
//      boundaryId: TestBoundaryId.test,
//      for: \.view
//    )
//
...
//    let multiPathReducer = baseReducer.lock<TestAction>(
//      boundaryId: TestBoundaryId.test,
//      for: \.view, \.delegate, \.increment, \.decrement, \.nonLockmanAction
//    )
//
...
//    let viewEffect = lockmanReducer.reduce(into: &state, action: TestAction.view(.buttonTapped))
//    let delegateEffect = lockmanReducer.reduce(into: &state, action: TestAction.delegate(.didComplete))
//    let rootEffect = lockmanReducer.reduce(into: &state, action: TestAction.increment)
//
...
//    let featureReducer = baseReducer.lock<TestAction>(
//      boundaryId: TestBoundaryId.navigation,
