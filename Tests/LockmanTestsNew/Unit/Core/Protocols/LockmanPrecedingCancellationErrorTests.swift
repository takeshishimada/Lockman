...
final class LockmanPrecedingCancellationErrorTests: XCTestCase {
  ...
  private struct TestLockmanInfo: LockmanInfo {
    ...
    init(strategyId: LockmanStrategyId = "TestStrategy", actionId: LockmanActionId = "testAction", priority: String = "high") {
  ...
  private struct TestPrecedingCancellationError: LockmanPrecedingCancellationError {
    ...
    init(lockmanInfo: any LockmanInfo, boundaryId: any LockmanBoundaryId, reason: String = "precedence") {
  ...
  func testLockmanPrecedingCancellationErrorProtocolHierarchy() {
    ...
    let error: any LockmanPrecedingCancellationError = TestPrecedingCancellationError(lockmanInfo: info, boundaryId: boundary)
  ...
  func testLockmanPrecedingCancellationErrorRequiredProperties() {
    ...
    let error = TestPrecedingCancellationError(lockmanInfo: info, boundaryId: boundary, reason: "test reason")
    ...
    XCTAssertEqual(error.errorDescription, "Preceding action cancelled: test reason (action: propertyTest)")
  }
  ...
  func testLockmanPrecedingCancellationErrorEnumConformance() {
    ...
    let boundary = UUID()
    let error = TestEnumPrecedingCancellationError.priorityPreemption(info: info, boundary: boundary)
  ...
  func testLockmanPrecedingCancellationErrorClassConformance() {
    ...
    let boundary = 42
    let timestamp = Date()
    let error = TestClassPrecedingCancellationError(lockmanInfo: info, boundaryId: boundary, timestamp: timestamp)
  ...
  func testLockmanPrecedingCancellationErrorAsLockmanStrategyError() {
    ...
    let precedingError: any LockmanPrecedingCancellationError = TestPrecedingCancellationError(lockmanInfo: info, boundaryId: boundary)
  ...
  func testLockmanPrecedingCancellationErrorAsLockmanError() {
    ...
    let precedingError: any LockmanPrecedingCancellationError = TestPrecedingCancellationError(lockmanInfo: info, boundaryId: "rootBoundary")
  ...
  func testLockmanPrecedingCancellationErrorAsStandardError() {
    ...
    let precedingError: any LockmanPrecedingCancellationError = TestPrecedingCancellationError(lockmanInfo: info, boundaryId: "errorBoundary")
  ...
  func testLockmanPrecedingCancellationErrorResultPattern() {
    ...
    let error = TestEnumPrecedingCancellationError.concurrencyLimit(info: info, boundary: "resultBoundary")
  ...
  func testLockmanPrecedingCancellationErrorTypeErasure() {
    ...
    let errors: [any LockmanPrecedingCancellationError] = [
      ...
      TestEnumPrecedingCancellationError.strategySpecific(info: info2, boundary: "boundary2", details: "custom"),
  ...
  func testLockmanPrecedingCancellationErrorGenericFunction() {
    ...
    let structError = TestPrecedingCancellationError(lockmanInfo: info, boundaryId: "genericBoundary")
    let enumError = TestEnumPrecedingCancellationError.priorityPreemption(info: info, boundary: "enumBoundary")
  ...
  func testLockmanPrecedingCancellationErrorBoundaryIdTypes() {
    ...
    let stringError = TestPrecedingCancellationError(lockmanInfo: info, boundaryId: "stringBoundary")
  ...
  func testLockmanPrecedingCancellationErrorSuccessWithPrecedingCancellationPattern() {
    ...
    let error = TestEnumPrecedingCancellationError.priorityPreemption(info: precedingInfo, boundary: "precedingBoundary")
  ...
  func testLockmanPrecedingCancellationErrorMultipleInfoTypes() {
    ...
    let customInfo = CustomInfo(actionId: "customAction", customData: ["priority": "high", "timeout": 30])
    let error = TestPrecedingCancellationError(lockmanInfo: customInfo, boundaryId: "customBoundary")
