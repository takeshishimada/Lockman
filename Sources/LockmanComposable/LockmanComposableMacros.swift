...
/// - Default `strategyId` implementation is provided by the protocol
///
/// **Important**: You must implement the `lockmanInfo` property to specify group coordination details:
/// - `groupId`: The group identifier for coordination
/// - `coordinationRole`: The role (.leader or .member)
///
/// Example usage with TCA:
/// ```swift
/// @Reducer
...
///       .init(
///         actionId: actionName,  // Generated by macro
///         groupId: "navigation",
